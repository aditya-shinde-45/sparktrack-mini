...
const MentorHeader = ({ name, id }) => {
  ...
  const getDashboardPath = () => {
    ...
    return currentPath.startsWith("/industry-mentor")
  ...
  const handleLogout = async () => {
    try {
      ...
      ["mentor_token", "mentor_refresh_token", "mentor_name", "mentor_id", "role", "token"].forEach(
  ...
  return (
    <>
      <header
        ...
        style={{
          background:
            "linear-gradient(100deg, rgba(109,88,240,0.9) 0%, rgba(78,56,199,0.92) 55%, rgba(59,42,173,0.94) 100%)",
